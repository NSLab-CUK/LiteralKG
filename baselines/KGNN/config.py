...
KG_FILE = {
           ...
           'intocns':os.path.join(RAW_DATA_DIR,'intocns','train2id.txt'),
           'kegg':os.path.join(RAW_DATA_DIR,'kegg','train2id.txt')}
ENTITY2ID_FILE = {
                    'drugbank':os.path.join(RAW_DATA_DIR,'drugbank','entity2id.txt'),
                    'intocns':os.path.join(RAW_DATA_DIR,'intocns','entity2id.txt'),
                    'kegg':os.path.join(RAW_DATA_DIR,'kegg','entity2id.txt')}
EXAMPLE_FILE = {
               'drugbank':os.path.join(RAW_DATA_DIR,'drugbank','approved_example.txt'),
               'intocns':os.path.join(RAW_DATA_DIR,'intocns','approved_example.txt'),
               'kegg':os.path.join(RAW_DATA_DIR,'kegg','approved_example.txt')}
SEPARATOR = {'drug':'\t','intocns':'\t','kegg':'\t'}
THRESHOLD = {'drug':4,'intocns':4,'kegg':4} #添加drug修改
NEIGHBOR_SIZE = {'drug':4,'intocns':4,'kegg':4}
...
RESULT_LOG={'drugbank':'drugbank_result.txt','intocns':'intocns_result.txt','kegg':'kegg_result.txt'}
